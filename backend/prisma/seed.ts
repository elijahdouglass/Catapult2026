...
const users = [
  { email: "jake_fitguy@test.com", displayName: "Jake Fitness", igUsername: "jake_fitguy", tags: "Fitness, Gym motivation, Workout routines, Meal prep, Protein shakes, CrossFit, Running, Yoga", likeThreshold: 3, worldIdVerified: true },
  { email: "maya_gamer@test.com", displayName: "Maya Gamer", igUsername: "maya_plays", tags: "Gaming, Esports, Twitch streams, Valorant, Minecraft builds, Speedruns, Game mods, Retro gaming", likeThreshold: 4, worldIdVerified: false },
  { email: "sofia_style@test.com", displayName: "Sofia Style", igUsername: "sofiastyle_", tags: "Fashion, Streetwear, Thrift hauls, Sneaker culture, Outfit ideas, Vintage fashion, Accessories, Style tips", likeThreshold: 2, worldIdVerified: true },
  { email: "liam_cooks@test.com", displayName: "Liam Cooks", igUsername: "liam_kitchen", tags: "Cooking, Baking, Food photography, Recipe hacks, Ramen, Korean BBQ, Vegan recipes, Meal prep", likeThreshold: 3, worldIdVerified: false },
  { email: "emma_wanders@test.com", displayName: "Emma Wanders", igUsername: "emma.wanders", tags: "Travel, Backpacking, Road trips, Beach vibes, City exploration, Hiking trails, Photography, Sunsets", likeThreshold: 5, worldIdVerified: false },
  { email: "noah_beats@test.com", displayName: "Noah Beats", igUsername: "noah_muzik", tags: "Music production, Guitar covers, Beatmaking, Vinyl collecting, Lo-fi beats, Hip hop, Jazz, Indie rock", likeThreshold: 3, worldIdVerified: true },
  { email: "aiko_otaku@test.com", displayName: "Aiko Anime", igUsername: "aiko_otaku", tags: "Anime, Manga, Cosplay, Studio Ghibli, One Piece fan art, Jujutsu Kaisen, Anime edits, Figure collecting", likeThreshold: 2, worldIdVerified: false },
  { email: "dev_marcus@test.com", displayName: "Marcus Dev", igUsername: "marcus_codes", tags: "Tech reviews, Programming, AI news, Gadgets, Mechanical keyboards, Linux, Web development, Startups", likeThreshold: 4, worldIdVerified: false },
  { email: "luna_artsy@test.com", displayName: "Luna Artsy", igUsername: "luna.draws", tags: "Art, Digital illustration, Watercolor, Sketching, Procreate tutorials, Abstract art, Gallery visits, Art history", likeThreshold: 3, worldIdVerified: false },
];
  ...
  for (let i = 0; i < users.length; i++) {
    ...
    const created = await prisma.user.create({
      data: {
        ...
        worldIdVerified: u.worldIdVerified,
      },
    });
